...
public class PlayerManager {
    ...
    public void initSavePlayerRunnable() {
        new SavePlayerRunnable(this.main, this)
                .runTaskTimer(this.main, TICKS_PER_SECOND * SECONDS_BETWEEN_SAVE, TICKS_PER_SECOND * SECONDS_BETWEEN_SAVE);
    }
    ...
    public Optional<PlayerCite> getPlayerCiteByName(String name) {
        return this.players.values().stream()
                .filter(playerCite -> playerCite.getName().equalsIgnoreCase(name))
                .findFirst();
    }
